...
export const PhoneMockup: React.FC<PhoneMockupProps> = ({ imgSrc, alt = 'App screenshot', className = '' }) => {
  return (
    <div className={`relative mx-auto border-slate-900 bg-slate-900 border-[14px] rounded-[2.5rem] h-[600px] w-[300px] shadow-2xl ${className}`}>
      ...
      <div className="rounded-[2rem] overflow-hidden w-full h-full bg-white relative">
        {/* Notch */}
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-32 h-7 bg-slate-900 z-20 rounded-b-2xl" aria-hidden="true"></div>
